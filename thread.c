...
void* count(void * param) // thread function 
{
	...
	usleep(bill_value*100);  //makes them finish at a different time. Shows the result $1, then $5, then $10, then $20, then $50 etc....
...
int main(int argc, char* argv[]){
	...
	// TODO: Create threads 
	// Your code here ...
    pthread_attr_t attr; //defualt set of thread attribite 
    for(int i = 0; i < NUM_COUNTERS; i++){
        pthread_create(&counters[i], NULL, count, (void*)(&bill_values[i]));
    }
